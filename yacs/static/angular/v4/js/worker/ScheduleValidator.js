...
// requires Worker.Utils
Worker.ScheduleValidator = function(conflictsObjects, sectionObjects){
	var conflictMap = Worker.Utils.hashById(conflictsObjects);
	var idToSection = Worker.Utils.hashById(sectionObjects);
	var self = this;
	...
	this.computeSchedules = function(courseIdsToSectionIds, num){
		...
		var possibleSchedules = Worker.Utils.product(sectionDomains);
		var validSchedules = [];
