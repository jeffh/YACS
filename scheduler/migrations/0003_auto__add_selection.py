...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scheduler_selection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('internal_slug', self.gf('django.db.models.fields.CharField')(default='', max_length=200, db_index=True, blank=True)),
            ('internal_crns', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('scheduler', ['Selection'])


    def backwards(self, orm):
        
        # Deleting model 'Selection'
        db.delete_table('scheduler_selection')
