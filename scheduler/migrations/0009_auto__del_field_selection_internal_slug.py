...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Selection.internal_slug'
        db.delete_column('scheduler_selection', 'internal_slug')


    def backwards(self, orm):
        # Adding field 'Selection.internal_slug'
        db.add_column('scheduler_selection', 'internal_slug',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True, db_index=True),
                      keep_default=False)
