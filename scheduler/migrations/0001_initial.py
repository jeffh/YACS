...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SectionConflict'
        db.create_table('scheduler_sectionconflict', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['scheduler.Section'])),
            ('section2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['scheduler.Section'])),
            ('semester', self.gf('django.db.models.fields.related.ForeignKey')(related_name='section_conflicts', to=orm['courses.Semester'])),
        ))
        db.send_create_signal('scheduler', ['SectionConflict'])

        # Adding unique constraint on 'SectionConflict', fields ['section1', 'section2', 'semester']
        db.create_unique('scheduler_sectionconflict', ['section1_id', 'section2_id', 'semester_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SectionConflict', fields ['section1', 'section2', 'semester']
        db.delete_unique('scheduler_sectionconflict', ['section1_id', 'section2_id', 'semester_id'])

        # Deleting model 'Section'
        db.delete_table('scheduler_section')

        # Deleting model 'SectionConflict'
        db.delete_table('scheduler_sectionconflict')
    ...
    models = {
        ...
        'scheduler.section': {
            'Meta': {'ordering': "['number']", 'object_name': 'Section', '_ormbases': ['courses.Section']},
            'conflicts_with': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scheduler.Section']", 'through': "orm['scheduler.SectionConflict']", 'symmetrical': 'False'}),
            'section_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['courses.Section']", 'unique': 'True', 'primary_key': 'True'})
        },
        'scheduler.sectionconflict': {
            'Meta': {'unique_together': "(('section1', 'section2', 'semester'),)", 'object_name': 'SectionConflict'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'section1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['scheduler.Section']"}),
            'section2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['scheduler.Section']"}),
