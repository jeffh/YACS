...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scheduler_schedule', (
            ...
            ('crns_used', self.gf('django.db.models.fields.SlugField')(max_length=200, db_index=True)),
            ('course_ids_used', self.gf('django.db.models.fields.CharField')(max_length=200, db_index=True)),
        ...
        # Adding model 'SectionInSchedule'
        db.create_table('scheduler_sectioninschedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sections_in_schedule', to=orm['scheduler.Schedule'])),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='section_in_schedules', to=orm['courses.Section'])),
            ('semester', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['courses.Semester'])),
        ))
        db.send_create_signal('scheduler', ['SectionInSchedule'])

        # Adding unique constraint on 'SectionInSchedule', fields ['schedule', 'section']
        db.create_unique('scheduler_sectioninschedule', ['schedule_id', 'section_id'])

        # Adding model 'CourseInSchedule'
        db.create_table('scheduler_courseinschedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses_in_schedule', to=orm['scheduler.Schedule'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='course_in_schedules', to=orm['courses.Course'])),
            ('semester', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['courses.Semester'])),
        ))
        db.send_create_signal('scheduler', ['CourseInSchedule'])

        # Adding unique constraint on 'CourseInSchedule', fields ['schedule', 'course']
        db.create_unique('scheduler_courseinschedule', ['schedule_id', 'course_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CourseInSchedule', fields ['schedule', 'course']
        db.delete_unique('scheduler_courseinschedule', ['schedule_id', 'course_id'])

        # Removing unique constraint on 'SectionInSchedule', fields ['schedule', 'section']
        db.delete_unique('scheduler_sectioninschedule', ['schedule_id', 'section_id'])

        # Deleting model 'Schedule'
        db.delete_table('scheduler_schedule')

        # Deleting model 'SectionInSchedule'
        db.delete_table('scheduler_sectioninschedule')

        # Deleting model 'CourseInSchedule'
        db.delete_table('scheduler_courseinschedule')
    ...
    models = {
        ...
        'scheduler.courseinschedule': {
            'Meta': {'unique_together': "(('schedule', 'course'),)", 'object_name': 'CourseInSchedule'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'course_in_schedules'", 'to': "orm['courses.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'courses_in_schedule'", 'to': "orm['scheduler.Schedule']"}),
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['courses.Semester']"})
        },
        'scheduler.schedule': {
            'Meta': {'object_name': 'Schedule'},
            'course_ids_used': ('django.db.models.fields.CharField', [], {'max_length': '200', 'db_index': 'True'}),
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'schedules'", 'symmetrical': 'False', 'through': "orm['scheduler.CourseInSchedule']", 'to': "orm['courses.Course']"}),
            'crns_used': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sections': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'schedules'", 'symmetrical': 'False', 'through': "orm['scheduler.SectionInSchedule']", 'to': "orm['courses.Section']"}),
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'schedules'", 'to': "orm['courses.Semester']"})
        },
        'scheduler.sectioninschedule': {
            'Meta': {'unique_together': "(('schedule', 'section'),)", 'object_name': 'SectionInSchedule'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sections_in_schedule'", 'to': "orm['scheduler.Schedule']"}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'section_in_schedules'", 'to': "orm['courses.Section']"}),
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['courses.Semester']"})
        }
    }
