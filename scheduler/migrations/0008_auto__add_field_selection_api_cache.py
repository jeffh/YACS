...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Selection.api_cache'
        db.add_column('scheduler_selection', 'api_cache', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Selection.api_cache'
        db.delete_column('scheduler_selection', 'api_cache')
