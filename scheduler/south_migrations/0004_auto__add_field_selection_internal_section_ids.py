...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Selection.internal_section_ids'
        db.add_column('scheduler_selection', 'internal_section_ids', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Selection.internal_section_ids'
        db.delete_column('scheduler_selection', 'internal_section_ids')
