...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Section.semester'
        raise RuntimeError("Cannot reverse this migration. 'Section.semester' and its values cannot be restored.")
