...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Period', fields ['start', 'end', 'days_of_week_raw']
        db.delete_unique('courses_period', ['start', 'end', 'days_of_week_raw'])

        db.rename_column('courses_period', 'days_of_week_raw', 'days_of_week_flag')

        # Adding unique constraint on 'Period', fields ['start', 'days_of_week_flag', 'end']
        db.create_unique('courses_period', ['start', 'days_of_week_flag', 'end'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Period', fields ['start', 'days_of_week_flag', 'end']
        db.delete_unique('courses_period', ['start', 'days_of_week_flag', 'end'])

        db.rename_column('courses_period', 'days_of_week_flag', 'days_of_week_raw')

        # Adding unique constraint on 'Period', fields ['start', 'end', 'days_of_week_raw']
        db.create_unique('courses_period', ['start', 'end', 'days_of_week_raw'])
