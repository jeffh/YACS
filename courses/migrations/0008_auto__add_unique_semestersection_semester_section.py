...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SemesterSection', fields ['semester', 'section']
        db.create_unique('courses_semestersection', ['semester_id', 'section_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SemesterSection', fields ['semester', 'section']
        db.delete_unique('courses_semestersection', ['semester_id', 'section_id'])
    ...
    models = {
        ...
        'courses.sectionperiod': {
            'Meta': {'unique_together': "(('period', 'section', 'semester'), ('period', 'semester'))", 'object_name': 'SectionPeriod'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
