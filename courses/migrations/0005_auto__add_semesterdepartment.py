...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'courses.department': {
            ...
            'semester': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'departments'", 'symmetrical': 'False', 'through': "orm['courses.SemesterDepartment']", 'to': "orm['courses.Semester']"})
        },
        'courses.offeredfor': {
        ...
        'courses.semesterdepartment': {
            'Meta': {'object_name': 'SemesterDepartment'},
