...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Department', fields ['code']
        db.create_unique('courses_department', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Department', fields ['code']
        db.delete_unique('courses_department', ['code'])
    ...
    models = {
        ...
        'courses.section': {
            ...
            'semester': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'sections'", 'symmetrical': 'False', 'through': "orm['courses.SemesterSection']", 'to': "orm['courses.Semester']"})
        },
