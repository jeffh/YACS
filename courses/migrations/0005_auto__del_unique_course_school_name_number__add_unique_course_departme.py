...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Course', fields ['school', 'name', 'number']
        db.delete_unique('courses_course', ['school_id', 'name', 'number'])

        # Adding unique constraint on 'Course', fields ['department', 'school', 'number']
        db.create_unique('courses_course', ['department_id', 'school_id', 'number'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Course', fields ['department', 'school', 'number']
        db.delete_unique('courses_course', ['department_id', 'school_id', 'number'])

        # Adding unique constraint on 'Course', fields ['school', 'name', 'number']
        db.create_unique('courses_course', ['school_id', 'name', 'number'])


    models = {
        'courses.course': {
            'Meta': {'unique_together': "(('department', 'number', 'school'),)", 'object_name': 'Course'},
