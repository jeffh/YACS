...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.date_created'
        db.add_column(u'courses_semester', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.date_created'
        db.delete_column(u'courses_semester', 'date_created')
