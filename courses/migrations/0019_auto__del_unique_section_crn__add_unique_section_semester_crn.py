...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'OfferedFor', fields ['ref']
        db.create_index('courses_offeredfor', ['ref'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'OfferedFor', fields ['ref']
        db.delete_index('courses_offeredfor', ['ref'])
    ...
    models = {
        ...
        'courses.section': {
            'Meta': {'ordering': "['number']", 'unique_together': "(('crn', 'semester'),)", 'object_name': 'Section'},
