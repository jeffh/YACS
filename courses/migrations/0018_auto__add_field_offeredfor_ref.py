...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfferedFor.ref'
        db.add_column('courses_offeredfor', 'ref',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfferedFor.ref'
        db.delete_column('courses_offeredfor', 'ref')
    ...
    models = {
        ...
        'courses.offeredfor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ref': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
