...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.date_updated'
        db.add_column('courses_course', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 1, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.date_updated'
        db.delete_column('courses_course', 'date_updated')
