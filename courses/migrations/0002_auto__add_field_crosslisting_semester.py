...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Crosslisting.semester'
        db.add_column('courses_crosslisting', 'semester', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='crosslistings', unique=True, to=orm['courses.Semester']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Crosslisting.semester'
        db.delete_column('courses_crosslisting', 'semester_id')
