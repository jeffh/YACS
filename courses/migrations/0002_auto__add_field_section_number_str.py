...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.number_str'
        db.add_column('courses_section', 'number_str', self.gf('django.db.models.fields.CharField')(default='0', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.number_str'
        db.delete_column('courses_section', 'number_str')


    models = {
        'courses.course': {
            'Meta': {'ordering': "['department__code', 'number']", 'unique_together': "(('department', 'number'),)", 'object_name': 'Course'},
        ...
        'courses.section': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {}),
            'number_str': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
