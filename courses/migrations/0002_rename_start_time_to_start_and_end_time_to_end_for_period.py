...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('courses_period', 'start_time', 'start')
        db.rename_column('courses_period', 'end_time', 'end')
    ...
    def backwards(self, orm):
        ...
        db.rename_column('courses_period', 'start', 'start_time')
        db.rename_column('courses_period', 'end', 'end_time')
    ...
    models = {
        ...
        'courses.period': {
            'Meta': {'unique_together': "(('start', 'end', 'days_of_week_raw'),)", 'object_name': 'Period'},
