...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SectionPeriod', fields ['semester', 'period']
        db.create_unique('courses_sectionperiod', ['semester_id', 'period_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SectionPeriod', fields ['semester', 'period']
        db.delete_unique('courses_sectionperiod', ['semester_id', 'period_id'])
