...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Course', fields ['department', 'name', 'number']
        db.delete_unique('courses_course', ['department_id', 'name', 'number'])


    def backwards(self, orm):
        # Adding unique constraint on 'Course', fields ['department', 'name', 'number']
        db.create_unique('courses_course', ['department_id', 'name', 'number'])
