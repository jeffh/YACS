...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('courses_section', 'number')


    def backwards(self, orm):
        
        # Adding field 'Section.number'
        db.add_column('courses_section', 'number', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'courses.section': {
            'Meta': {'ordering': "['number_str']", 'object_name': 'Section'},
