...
urlpatterns = patterns('',
    ...
    url(r'^v1/latest/$', views.SemesterDetailView.as_view(), name='latest-semester'),
    url(r'^v1/latest/departments/$', views.DepartmentListView.as_view(), name='latest-departments'),
    url(r'^v1/latest/departments/(?P<code>[A-Z]+)/$', views.CourseByDeptListView.as_view(), name='latest-courses-by-dept'),
    url(r'^v1/latest/search/$', views.SearchCoursesListView.as_view(), name='latest-search-all-courses'),
    url(r'^v1/latest/courses/$', views.CourseListView.as_view(), name='latest-courses'),
    url(r'^v1/latest/courses/(?P<cid>\d+)/$', views.CourseDetailView.as_view(), name='latest-course'),
    url(r'^v1/latest/departments/(?P<code>[A-Z]+)/(?P<number>[1-9]\d*)/$', views.CourseDetailView.as_view(), name='latest-course-by-code'),
    url(r'^v1/latest/departments/(?P<code>[A-Z]+)/(?P<number>[1-9]\d*)/sections/$', views.SectionListView.as_view(), name='latest-sections'),
    url(r'^v1/latest/departments/(?P<code>[A-Z]+)/(?P<number>[1-9]\d*)/sections/(?P<crn>\d+)/$', views.SectionDetailView.as_view(), name='latest-section'),
    url(r'^v1/latest/sections/$', views.SectionListView.as_view(), name='latest-sections'),
    url(r'^v1/latest/sections/(?P<crn>\d+)/$', views.SectionDetailView.as_view(), name='latest-section'),
    ...
    url(r'^v1/(?P<year>[1-9]\d*)/(?P<month>[1-9]\d*)/departments/(?P<code>[A-Z]+)/(?P<number>[1-9]\d*)/sections/(?P<crn>\d+)/$', views.SectionDetailView.as_view(), name='section'),
