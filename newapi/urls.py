...
urlpatterns = patterns('',
    ...
    url(r'^v2/(?P<year>[1-9]\d*)/(?P<month>[1-9]\d*)/departments/(?P<code>[A-Z]+)/(?P<number>[1-9]\d*)/sections/(?P<secnum>[\da-zA-Z]+)/$', views.SectionDetailView.as_view(), name='section'),
    ...
    url(r'^v2/latest/departments/(?P<code>[A-Z]+)/(?P<number>[1-9]\d*)/sections/(?P<secnum>[\da-zA-Z]+)/$', views.SectionDetailView.as_view(), name='section'),
